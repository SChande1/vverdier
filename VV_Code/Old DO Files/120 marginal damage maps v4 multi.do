...
if "`case'"=="con" merge 1:1 idnum using "data/hourly22/coefsconstrained_`level'`thehour'.dta", nogen keep(3)
...
if "`case'"=="con" merge 1:1 idnum using "data/hourly22/coefsconstrained_`level'`thehour'.dta", nogen keep (1 2 3)
