...
if "`case'" =="con"{
spmap using "data/Maps/US_County_LowRes_2013coord_Stata11.dta", osize(none ..) ndsize(none ..)  id(_ID) line(data("data/Maps/US_States_LowRes_2015coord_Stata11.dta") select(drop if inlist(_ID,2,3,8,14,15,43,49))) point(data($temp5 ) xcoord(_X) ycoord(_Y) proportional(btilda`lreg'2) by(group) fcolor($colors) size(*.5) $gropts ) xsize(2.5) ysize(2) saving(${tempdir}/gr`lreg'map, replace)   graphregion(color(white) margin(none))
...
twoway (line btilda`reg' localhour if case=="con" & Fuel=="Wind",lcolor(green) lwidth(thick))  (line btilda`reg' localhour if case=="con" & Fuel=="Gas", lcolor(sienna) lwidth(thick)) (line btilda`reg' localhour if case=="con" & Fuel=="Coal", lcolor(black) lwidth(thick)) (line btilda`reg' localhour if case=="con" & Fuel=="Sun", lcolor(orange) lwidth(thick)) (line btilda`reg' localhour if case=="con" & Fuel=="Hydro", lcolor(blue) lwidth(thick)) (line btilda`reg' localhour if case=="con" & Fuel=="Nuke", lcolor(purple) lwidth(thick)) (line btilda`reg' localhour if case=="con" & Fuel=="Trade", lcolor(pink) lwidth(thick)) (line btilda`reg' localhour if case=="con" & Fuel=="remainder", lcolor(gray) lwidth(thick)), $gropts  xsize(2.5) ysize(2) saving(${tempdir}/grcon`reg'_fuel.gph, replace) xlabel(1 6 12 18 24) ylabel(0(.2)1, angle(0))


}
** legend only 
twoway (line btildaTEX utchour if case=="con" & Fuel=="Wind",lcolor(green) lwidth(thick))  (line btildaTEX utchour if case=="con" & Fuel=="Gas", lcolor(sienna) lwidth(thick)) (line btildaTEX utchour if case=="con" & Fuel=="Coal", lcolor(black) lwidth(thick)) (line btildaTEX utchour if case=="con" & Fuel=="Sun", lcolor(orange) lwidth(thick)) (line btildaTEX utchour if case=="con" & Fuel=="Hydro", lcolor(blue) lwidth(thick)) (line btildaTEX utchour if case=="con" & Fuel=="Nuke", lcolor(purple) lwidth(thick)) (line btildaTEX utchour if case=="con" & Fuel=="Trade", lcolor(pink) lwidth(thick)) (line btildaTEX utchour if case=="con" & Fuel=="remainder", lcolor(gray) lwidth(thick)), graphregion(color(white)) legend(cols(4) label(1 "Wind") label(2 "Gas") label(3 "Coal") label(4 "Sun") label(5 "Hydro") label(6 "Nucl.") label(7 "Trade") label(8 "Other") size(14pt) position(6) ) 
graph export "$tempdir/latex22/fig-fuel-coefsLEGEND.png", replace width(1500)
...
graph combine  ${tempdir}/grcon`reg'_fuel.gph ${tempdir}/gr`reg'map.gph, title("`name`reg''") $graphoptions
graph display temp, xsize(5) ysize(2)
graph export "${tempdir}/latex22/coeff_map_region2_`reg'`thehour'.png", replace width(1500)
}
...
if "`case'" =="uncon"{
spmap using "data/Maps/US_County_LowRes_2013coord_Stata11.dta", osize(none ..) ndsize(none ..)  id(_ID) line(data("data/Maps/US_States_LowRes_2015coord_Stata11.dta") select(drop if inlist(_ID,2,3,8,14,15,43,49))) point(data($temp5 ) xcoord(_X) ycoord(_Y) proportional(btilda`lreg'2) by(group) fcolor($colors) size(*.5) $gropts ) xsize(2.5) ysize(2) saving(${tempdir}/gr`lreg'unconmap, replace)   graphregion(color(white) margin(none))
}
if "`case'" =="con"{
spmap using "data/Maps/US_County_LowRes_2013coord_Stata11.dta", osize(none ..) ndsize(none ..)  id(_ID) line(data("data/Maps/US_States_LowRes_2015coord_Stata11.dta") select(drop if inlist(_ID,2,3,8,14,15,43,49))) point(data($temp5 ) xcoord(_X) ycoord(_Y) proportional(btilda`lreg'2) by(group) fcolor($colors) size(*.5) $gropts ) xsize(2.5) ysize(2) saving(${tempdir}/gr`lreg'map, replace)   graphregion(color(white) margin(none))
...
global gropts graphregion(color(white)) xtitle("Hour (local time)") ytitle("Marginal generation share") 

twoway (line btilda`reg' localhour if case=="uncon" & Fuel=="Wind",lcolor(green) lwidth(thick))  (line btilda`reg' localhour if case=="uncon" & Fuel=="Gas", lcolor(sienna) lwidth(thick)) (line btilda`reg' localhour if case=="uncon" & Fuel=="Coal", lcolor(black) lwidth(thick)) (line btilda`reg' localhour if case=="uncon" & Fuel=="Sun", lcolor(orange) lwidth(thick)) (line btilda`reg' localhour if case=="uncon" & Fuel=="Hydro", lcolor(blue) lwidth(thick)) (line btilda`reg' localhour if case=="uncon" & Fuel=="Nuke", lcolor(purple) lwidth(thick)) (line btilda`reg' localhour if case=="uncon" & Fuel=="Trade", lcolor(pink) lwidth(thick)) (line btilda`reg' localhour if case=="uncon" & Fuel=="remainder", lcolor(gray) lwidth(thick)), $gropts  xsize(2.5) ysize(2) saving(${tempdir}/gruncon`reg'_fuel.gph, replace) xlabel(1 6 12 18 24) ylabel(0(.2)1, angle(0)) legend(cols(4) label(1 "Wind") label(2 "Gas") label(3 "Coal") label(4 "Sun") label(5 "Hydro") label(6 "Nucl.") label(7 "Trade") label(8 "Other") position(6) ) 
...
foreach reg in  NY {
global graphoptions graphregion(color(white) margin(zero zero zero zero)) name(temp, replace)
graph combine  ${tempdir}/gruncon`reg'_fuel.gph ${tempdir}/gr`reg'unconmap.gph,  $graphoptions
graph display temp, xsize(5) ysize(2)
graph export "${tempdir}/latex22/NY_OLS.png", replace width(1500)
}
