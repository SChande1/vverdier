...
if "`case'"=="con"{
	merge 1:1 idnum using "data/hourly22/coefsconstrained_inter`thehour'_uni.dta", nogen keep(2 3)
}
if "`case'"=="uncon"{
...
if "`case'"=="con"{
	merge 1:1 idnum using "data/hourly22/coefsconstrained_sub`thehour'_uni.dta", nogen keep(2 3)
}
if "`case'"=="uncon"{
...
merge 1:1 idnum using "data/hourly22/coefsconstrained_`level'`thehour'_uni.dta", nogen keep(2 3)
...
graph export "latex22/fuel_scatter`level'.png", replace																						
